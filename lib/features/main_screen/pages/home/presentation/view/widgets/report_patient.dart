...
class CustomReportPatient extends StatefulWidget {
  CustomReportPatient({
    Key? key,
    required this.patientReportData,
  }) : super(key: key);

  PatientReportData patientReportData;

  @override
  State<CustomReportPatient> createState() => _CustomReportPatientState();
}

class _CustomReportPatientState extends State<CustomReportPatient> {
  ...
  void convertMedicineToList(){
    print(widget.patientReportData.medicines);
    Map<String, dynamic> mapMedicine = (widget.patientReportData.medicines!="")?jsonDecode(widget.patientReportData.medicines!):{} ;
                  ...
                  SpeedDialChild(
                      ...
                      onTap: () {
                        ...
                        context.read<ReportDetailsCubit>().sendMessage(
                            diagnosisDoctor: widget.patientReportData.diagnosis??"No there diagnosis",
                            advicesDoctor: widget.patientReportData.advices??"No there advices",
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${widget.patientReportData.appointment?.name}",
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${widget.patientReportData.appointment?.age}",
                                      style: TextStyleHelper.style10B.copyWith(
                                          color: ColorHelper.grayText),
                                    ),
                                  ],
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${(widget.patientReportData.appointment?.sex==1)?"male":"female"}",
                                      style: TextStyleHelper.style10B.copyWith(
                                          color: ColorHelper.grayText),
                                    ),
                                  ],
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      "${widget.patientReportData.createdAt.toString().replaceRange(widget.patientReportData.appointment!.createdAt.toString().length-8,widget.patientReportData.appointment?.createdAt.toString().length , "")}",
                                      style: TextStyleHelper.style10B.copyWith(
                                          color: ColorHelper.grayText),
                                    ),
                                  ],
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(
                            ...
                            FixedVariables.widthScreenQuery(contextReportDetailsCubit) *
                                0.05),
                        child: Text(
                          "${widget.patientReportData.diagnosis}",
                          //"The diagnostic results indicate that the patient has pneumonia, which is possible that the patient is infected with the Covid-19 virus, so the patient must do a Covid-19 swab.",
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(
                            ...
                            FixedVariables.widthScreenQuery(contextReportDetailsCubit) *
                                0.05),
                        child: Text(
                          "${widget.patientReportData.advices}",
                          //"Complete rest throughout the day and do not do any effort until you recover.Drink plenty of fluids to help thin the mucus.Quit smoking and avoid passive smoking.Lie down with your head and back elevated to help you breathe better.",
                          style: TextStyleHelper.style12R
                              .copyWith(color: ColorHelper.grayText),
                        ),
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            "Dr. ${widget.patientReportData.doctor?.phone}",
                            style: TextStyleHelper.style8R
                                .copyWith(color: ColorHelper.grayText),
                          ),
                          Text(
                            "No. ${widget.patientReportData.doctor?.phone}",
                            style: TextStyleHelper.style8R
                                .copyWith(color: ColorHelper.grayText),
                          ),
                          Text(
