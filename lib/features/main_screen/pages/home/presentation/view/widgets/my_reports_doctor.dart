...
class MyReportsDoctor extends StatelessWidget {
  const MyReportsDoctor({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: BlocBuilder<DeleteReportCubit,DeleteReportState>(
        builder: (context,deletingState) {
            return Stack(
              children: [
                BlocBuilder<GetDoctorReportsCubit,GetDoctorReportsState>(
                    builder: (context,doctorReportsState) {
                      if(doctorReportsState is LoadingGetDoctorReportsState){
                        return Container(
                      ...
                      }else if(doctorReportsState is SuccessGetDoctorReportsState){
                        return Padding(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: RefreshIndicator(
                                  ...
                                  child: ListView.builder(
                                      itemCount: doctorReportsState.doctorsReports.length,
                                      ...
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: (){
                                              ...
                                              Navigator.push(context, PageTransition(
                                                child: BlocProvider(
                                                  ...
                                                  child: CustomReportDoctor(doctorReportData:doctorReportsState.doctorsReports[index]),
                                                ),
                                            ...
                                            child: CustomReportViewDoctor(
                                              listOfItems: doctorReportsState.doctorsReports[index],
                                            ),
                                          ),
                                        );
                                      }),
