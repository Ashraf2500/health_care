...
class DoctorScheduleDetails extends StatelessWidget {
  DoctorScheduleDetails({
    Key? key,
    required this.doctorAppointmentData
  }) : super(key: key);

  final DoctorAppointmentsData doctorAppointmentData ;
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.doctor?.name}",
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.doctor?.phone}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "${checkDepartmentOfDoctorFunc(departmentId: doctorAppointmentData.doctor?.speciality)}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.doctor?.expertment}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            RatingBar.builder(
                              initialRating: (doctorAppointmentData.doctor?.ratingPoints==null)?0:doctorAppointmentData.doctor!.ratingPoints!.toDouble() ,
                              minRating: 1,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.owner?.name}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.owner?.phone}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "${(doctorAppointmentData.sex==1)?"Male":"Female"}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              "${doctorAppointmentData.turn}",
                              style: TextStyleHelper.style14M.copyWith(color: ColorHelper.grayText),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ],
                        ),
                        (doctorAppointmentData.completed==1)
                            ?Row(
                          children: [
                            Text(
                              "State : ",
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Scrollbar(
                          ...
                          child: (doctorAppointmentData.description!.replaceAll(RegExp(r'\s+'), '').isNotEmpty)
                              ?SingleChildScrollView(
                            child: Text(
                              "${doctorAppointmentData.description}",
