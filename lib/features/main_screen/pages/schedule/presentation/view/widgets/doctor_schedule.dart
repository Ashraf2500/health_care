...
class DoctorSchedule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<GetDoctorAppointmentsCubit,GetDoctorAppointmentsState>(
        builder: (context,doctorAppointmentState) {
          if(doctorAppointmentState is LoadingDoctorAppointmentsAppointmentsState){
            return  Container(
          ...
          else if(doctorAppointmentState is SuccessDoctorAppointmentsAppointmentsState){
            return BlocBuilder<ConfirmAppointmentCubit,ConfirmAppointmentState>(
              builder: (context,ConfirmState) {
                return BlocBuilder<DeleteAppointmentCubit,DeleteAppointmentState>(
                  builder: (context,cancelDoctorAppointmentState) {
                    return Flexible(
                         child: Stack(
                           children: [
                             Stack(
                               children: [
                                 Padding(
                                   ...
                                   child: RefreshIndicator(
                                     ...
                                     child: (doctorAppointmentState.doctorAppointmentsNotCompleted.isNotEmpty)?ListView.builder(
                                         itemCount: doctorAppointmentState.doctorAppointmentsNotCompleted.length,
                                         ...
                                         itemBuilder: (context, index) {
                                           return Padding(
                                             ...
                                             child: CustomDoctorAppointmentItem(
                                               listOfItemsType: DoctorAppointmentItem.DoctorSchedule,
                                               index: index,
                                               withDetails: true,
                                               withCancel: true,
                                               ...
                                               listOfItem: doctorAppointmentState.doctorAppointmentsNotCompleted,
                                 ...
                                 (ConfirmState is LoadingConfirmAppointmentState)?Container(
                             ...
                             (cancelDoctorAppointmentState is LoadingDeleteAppointmentState)
                                 ?Container(
                               height: _heightScreen*0.86,
                               width: _widthScreen,
                               decoration: BoxDecoration(
